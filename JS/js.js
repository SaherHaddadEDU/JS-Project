...
const contacts =
  [
    ...
    {
      image: "https://scontent.ftlv5-1.fna.fbcdn.net/v/t51.75761-15/488912050_18504671503037052_8005623173805717194_n.jpg?stp=dst-jpegr_tt6&_nc_cat=105&ccb=1-7&_nc_sid=127cfc&_nc_ohc=lK4GgTfCT8cQ7kNvwEbco6z&_nc_oc=AdkXnBWx9baA3N-ML6kWRZ6haHOh4ayQK2ObrmBlUINisWfgbZwFFLrPG4ZUlRXlKkuBIR1SDsUmcF2z3Gx4z9C8&_nc_zt=23&se=-1&_nc_ht=scontent.ftlv5-1.fna&_nc_gid=G_GGnQtB3bycx2cG89E4tQ&oh=00_AfNaoetxkXgNINGUiN5m2ApvP-eMTy1fVtLpzVrFBtGewQ&oe=685DC695",
...
function createContactForm(mode, index) {
  ...
  document.getElementById(isEdit ? 'saveEdit' : 'addContact').addEventListener('click', (e) => {
    ...
    removeList();
    if (isEdit) {
      newContact.updates = contacts[index].updates || []; // שמור היסטוריה קודמת
      newContact.updates.push(new Date().toLocaleString()); // הוסף חדש
